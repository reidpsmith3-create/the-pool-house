...
export default async function SurvivorSetupPage({ params }: PageProps) {
    ...
    <main className="min-h-screen bg-[#0d0f12] px-5 py-8 text-zinc-50">
      <div className="mx-auto max-w-md">
        <p className="text-xs font-black uppercase text-amber-300">
          Admin · Survivor Setup
        </p>
        <h1 className="mt-3 text-3xl font-black">Survivor Setup</h1>
        ...
        <div className="mt-6 rounded-3xl border border-zinc-700/70 bg-gradient-to-b from-[#202226] to-[#15161a] p-5">
          ...
          <p className="mt-2 text-sm text-zinc-400">
            This page will eventually manage NFL teams, weekly picks,
            eliminations, and survivor results.
          </p>
        </div>
