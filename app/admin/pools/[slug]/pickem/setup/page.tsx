...
export default async function PickemSetupPage({ params }: PageProps) {
  ...
  return (
    <main className="min-h-screen bg-[#0d0f12] px-5 py-8 text-zinc-50">
      <div className="mx-auto max-w-md">
        ...
        <h1 className="mt-3 text-3xl font-black">Pick&apos;em Setup</h1>
        ...
        <div className="mt-6 rounded-3xl border border-zinc-700/70 bg-gradient-to-b from-[#202226] to-[#15161a] p-5">
          ...
          <p className="mt-2 text-sm text-zinc-400">
            This page will eventually manage games, spreads, weekly picks,
