...
export default async function BracketSetupPage({ params }: PageProps) {
      ...
      <div className="mx-auto max-w-md">
        ...
        <div className="mt-6 rounded-3xl border border-zinc-700/70 bg-gradient-to-b from-[#202226] to-[#15161a] p-5">
          ...
          <p className="mt-2 text-sm text-zinc-400">
            This page will eventually manage bracket teams, matchups, user
            brackets, scoring, and winners.
          </p>
        </div>
